...
class Purchases(Base):
    ...
    customer_inn = Column(Integer, nullable=False, unique=False)
...
class Companies(Base):
    ...
    supplier_kpp = Column(String, nullable=True, unique=True)
    okved = Column(String, nullable=True, unique=True)
